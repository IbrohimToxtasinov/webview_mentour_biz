...
class SpeakingTaskItem extends StatefulWidget {
  final Task task;
  final VoidCallback? onTap;
  final bool isExam;

  const SpeakingTaskItem({
    super.key,
    required this.task,
    required this.onTap,
    this.isExam = false,
  ...
  @override
  State<SpeakingTaskItem> createState() => _SpeakingTaskItemState();
}

class _SpeakingTaskItemState extends State<SpeakingTaskItem> {
  ...
  Widget build(BuildContext context) {
    ...
    final isGraded = widget.task.resSpeaking.isEmpty
        ? false
        : widget.task.resSpeaking.first.status == "GRADED";
    final isPending = widget.task.resSpeaking.isEmpty
        ? false
        : widget.task.resSpeaking.first.status == "PROCESSING";
    ...
    return AnimatedContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  showStatusText(
                    widget.task.resSpeaking.isEmpty
                        ? ""
                        : widget.task.resSpeaking.first.status,
                  ),
                  style: TextStyle(
                    fontSize: 11,
          ...
          if ((isGraded || isPending) &&
            ...
            Padding(
              ...
              child: CustomAudioPlayer(
                ...
                isLocalFile: false,
                onDelete: null, // O'chirish tugmasi yashirin bo'ladi
              ),
            ),
          ...
          if (isGraded &&
              isExpanded &&
              widget.task.resSpeaking.first.feedbackBullets.isNotEmpty)
            AnimatedContainer(
              duration: const Duration(milliseconds: 300),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      widget.task.resSpeaking.first.feedbackBullets.join('\n'),
