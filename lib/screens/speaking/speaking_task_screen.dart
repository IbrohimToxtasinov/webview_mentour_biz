...
class SpeakingTaskScreen extends StatefulWidget {
  final String taskId;
  final String unitId;

  const SpeakingTaskScreen({
    super.key,
  ...
  @override
  State<SpeakingTaskScreen> createState() => _SpeakingTaskScreenState();
}

class _SpeakingTaskScreenState extends State<SpeakingTaskScreen>
  ...
  Future<void> _stopRecording() async {
    ...
    if (path != null) {
      if (kIsWeb) {
        // Web: path is a blob URL, use UrlSource
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: MainActionButton(
                                        ...
                                        height: 38,
                                        enabled: _hasRecorded && !_isRecording,
                                        onTap: () async {
                                          context
