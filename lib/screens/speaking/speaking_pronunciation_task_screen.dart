...
class SpeakingPronunciationTaskScreen extends StatefulWidget {
  final String taskId;
  final String unitId;
  final int maxAttempts;

  const SpeakingPronunciationTaskScreen({
    super.key,
  ...
  @override
  State<SpeakingPronunciationTaskScreen> createState() =>
      _SpeakingPronunciationTaskScreenState();
}

class _SpeakingPronunciationTaskScreenState
    extends State<SpeakingPronunciationTaskScreen>
